...
func UpdateNotification(c *gin.Context) {
	id := c.Param("id")
	var notification Notification
	if err := db.Where("id_notification = ?", id).First(&notification).Error; err != nil {
...
func DeleteNotification(c *gin.Context) {
	id := c.Param("id")
	var notification Notification
	db.Where("id_notification = ?", id).Delete(&notification)
...
func GetNotificationByID(c *gin.Context) {
	...
	var notification Notification
	if err := db.First(&notification, "id_notification = ?", NotificationID).Error; err != nil {
